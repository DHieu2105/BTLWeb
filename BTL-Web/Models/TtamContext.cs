...
public partial class TtamContext : DbContext
{
    public TtamContext()
    {
    }

    public TtamContext(DbContextOptions<TtamContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PUNNOHOANG;Initial Catalog=TTam;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False;Command Timeout=30");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<DangKi>(entity =>
        {
            entity.HasKey(e => new { e.MaKhoaHoc, e.MaHocVien }).HasName("PK__DangKi__FE754F7E4C8C7DBC");
        ...
        {
            entity.HasKey(e => e.MaGv).HasName("PK__GiaoVien__2725AEF37F956F7A");
            ...
            entity.HasMany(d => d.MaHocViens).WithMany(p => p.MaGvs)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaGv", "MaHocVien").HasName("PK__GiangDay__91A01E1578C25909");
                        j.ToTable("GiangDay");
        ...
        {
            entity.HasKey(e => e.MaHocVien).HasName("PK__HocVien__685B0E6AC28F1B9C");
        ...
        {
            entity.HasKey(e => new { e.MaHocVien, e.MaKhoaHoc }).HasName("PK__KetQua__FCD40193B7828B94");
        ...
        {
            entity.HasKey(e => e.MaKhoaHoc).HasName("PK__KhoaHoc__48F0FF9889D1DE05");
        ...
        {
            entity.HasKey(e => e.MaLichHoc).HasName("PK__LichHoc__150EBC216B6630AE");
        ...
        {
            entity.HasKey(e => e.MaLop).HasName("PK__LopHoc__3B98D273FD915344");
            ...
            entity.HasMany(d => d.MaHocViens).WithMany(p => p.MaLops)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaLop", "MaHocVien").HasName("PK__ThamGia__8D1D629523CDA808");
                        j.ToTable("ThamGia");
        ...
        {
            entity.HasKey(e => e.MaNv).HasName("PK__NhanVien__2725D70AEE489154");
            ...
            entity.HasMany(d => d.MaGvs).WithMany(p => p.MaNvs)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaNv", "MaGv").HasName("PK__PhanCong__05578DE511BEF9CD");
                        j.ToTable("PhanCong");
        ...
        {
            entity.HasKey(e => e.MaPhong).HasName("PK__PhongHoc__20BD5E5B89873BAF");
            ...
            entity.HasMany(d => d.MaThietBis).WithMany(p => p.MaPhongs)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaPhong", "MaThietBi").HasName("PK__SuDung__48139944DA11E4A8");
                        j.ToTable("SuDung");
        ...
        {
            entity.HasKey(e => e.Username).HasName("PK__TaiKhoan__536C85E5FE8B738D");
        ...
        {
            entity.HasKey(e => e.MaThietBi).HasName("PK__ThietBi__8AEC71F7C997F248");
        ...
        {
            entity.HasKey(e => e.MaTrungTam).HasName("PK__TrungTam__54A2B84FBB24F07D");
